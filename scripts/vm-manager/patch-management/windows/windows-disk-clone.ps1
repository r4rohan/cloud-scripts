# This particular code has written by Christoph Petersen, Solution Lead, Google Cloud Platform EMEA. We've taken this script and modified accordingly for other 2 use-cases.
# Full Credit and ownership goes to him: https://github.com/peterschen/blog/blob/master/gcp/samples/ospatch-clone/clone-windows.ps1
